  ...
  return (
    <div>
      ...
      <input
        id={id}
        {...props}
        className={`block w-full bg-white dark:bg-slate-900 border rounded-md shadow-sm py-2 px-3 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 sm:text-sm ${error ? errorClasses : defaultClasses}`}
        aria-invalid={!!error}
