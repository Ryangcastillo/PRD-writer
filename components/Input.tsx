  ...
  return (
    <div>
      ...
      <input
        id={id}
        {...props}
        className={`block w-full bg-white dark:bg-slate-950 border rounded-lg shadow-sm py-2.5 px-3.5 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 sm:text-sm transition-all duration-200 ${error ? errorClasses : defaultClasses}`}
        aria-invalid={!!error}
